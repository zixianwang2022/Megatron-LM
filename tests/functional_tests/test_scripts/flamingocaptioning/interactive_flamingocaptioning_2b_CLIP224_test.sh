...
TP_SIZE=1
PP_SIZE=1
export ADDITIONAL_PARAMS="--visual-arch L_14 --visual-type vit --visual-path /lustre/fsw/adlr/adlr-nlp/adlr_ci/megatron/data/flamingo_data/vit_L_14 --img-h 224 --img-w 224"
