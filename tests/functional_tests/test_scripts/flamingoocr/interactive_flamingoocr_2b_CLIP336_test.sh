...
CHECKPOINT_PATH=/lustre/fsw/adlr/adlr-nlp/jbarker/next-llm/output/flamingoocr_2b_CLIP336_test/checkpoints
TENSORBOARD_DIR=/lustre/fsw/adlr/adlr-nlp/jbarker/next-llm/output/flamingoocr_2b_CLIP336_test/tensorboard_logs
...
python tests/functional_tests/python_test_utils/get_test_results_from_tensorboard_logs.py /lustre/fsw/adlr/adlr-nlp/jbarker/next-llm/output/flamingoocr_2b_CLIP336_test/tensorboard_logs flamingoocr_2b_CLIP336_test

export EXPECTED_METRICS_FILE=tests/functional_tests/test_results/flamingoocr/flamingoocr_2b_CLIP336_test.json

export LOGS_DIR=/lustre/fsw/adlr/adlr-nlp/jbarker/next-llm/output/flamingoocr_2b_CLIP336_test/tensorboard_logs
