...
# Input model path
MODEL_DIR="/lustre/fsw/llmservice_nlp_fm/yihuih/checkpoints/15b/gpt3-15b-8t-shuffle-mup/base"

# Output model
TARGET_TP=4
TARGET_PP=8
SAVE_DIR="/lustre/fsw/llmservice_nlp_fm/yihuih/checkpoints/15b/gpt3-15b-8t-tp4-pp8"
