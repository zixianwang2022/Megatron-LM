...
if __name__ == "__main__":
        ...
        argparser.add_argument("--step", type=int, default=4500)
        ...
        n_ctx=5
        step=args.step
        prediction_file = ckpt_path + "/inference_input_retriever_dragon_msmarcominilm_doc2dial_{}_generate_43b_test_greedy_0_250_{}_ret.txt.v2".format(n_ctx, step)
        ...
        prediction_file = ckpt_path + "/Iternal_dragon_retriever_msmarcominilm_reranker_chunkbysents300_retrieved_{}_generate_43b_test_greedy_0_250_{}_ret.txt.v2".format(n_ctx, step)
        ...
        prediction_file = ckpt_path + "/NVIT_dragon_retriever_msmarcominilm_reranker_chunkbysents300_retrieved_{}_generate_43b_test_greedy_0_250_{}_ret.txt.v2".format(n_ctx, step)
        ...
        prediction_file = ckpt_path + "/nv_benefits_dragon_retriever300_retrieved_generic_{}_generate_43b_test_greedy_0_250_{}_ret.txt.v2".format(n_ctx, step)
        ground_truth_file = "/lustre/fsw/adlr/adlr-nlp/pengx/retro/data/nv_benefits_dragon_retriever300_retrieved_generic/test.json"
        print(prediction_file)
        print(ground_truth_file)
        all_f1.append(evaluate_f1(ground_truth_file, prediction_file))

        prediction_file = ckpt_path + "/landrover_plus_benz_clean_plus_ford_tasb_ftmsmarcominilm_chunkbysents150_benzlandroverford_retrieved_{}_generate_43b_test_greedy_0_250_{}_ret.txt.v2".format(n_ctx, step)
        ...
        prediction_file = ckpt_path + "/ford_tasb_ftmsmarcominilm_chunkbysents150_benzlandroverford_retrieved_{}_generate_43b_test_greedy_0_250_{}_ret.txt.v2".format(n_ctx, step)
        ...
        prediction_file = ckpt_path + "/att_dragon_retriever_msmarcominilm_reranker_chunkbysents300_retrieved_{}_generate_43b_test_greedy_0_250_{}_ret.txt.v2".format(n_ctx, step)
        ...
        prediction_file = ckpt_path + "/nq_{}_generate_43b_test_greedy_0_200_{}_ret.txt.v2".format(n_ctx, step)
