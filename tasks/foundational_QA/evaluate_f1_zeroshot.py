...
if __name__ == "__main__":
        ...
        model_name = "qa_blendv10_gpt_1e-8_conv_quiet_cockatoo_pp1_same_format_ctx1_43b_64_3e-7"
        ckpt_path="/lustre/fsw/adlr/adlr-nlp/pengx/sft_43b_qa/checkpoints/applications/{}/".format(model_name)
        ckpt_path="/lustre/fsw/adlr/adlr-nlp/pengx//shared_ckpts/megatron_sft_quiet_cockatoo_tp8_pp1/"
        n_ctx=10
        prediction_file = ckpt_path + "/inference_input_retriever_dragon_msmarcominilm_doc2dial_{}_generate_43b_test_greedy_0_250_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/Iternal_dragon_retriever_msmarcominilm_reranker_chunkbysents300_retrieved_{}_generate_43b_test_greedy_0_250_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/NVIT_dragon_retriever_msmarcominilm_reranker_chunkbysents300_retrieved_{}_generate_43b_test_greedy_0_250_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/nv_benefits_dragon_retriever300_retrieved_generic_{}_generate_43b_test_greedy_0_250_ret.txt.v2".format(n_ctx)
        ground_truth_file = "/lustre/fsw/adlr/adlr-nlp/pengx/retro/data/nv_benefits_dragon_retriever300_retrieved_generic/test.json"
        print(prediction_file)
        print(ground_truth_file)
        evaluate_f1(ground_truth_file, prediction_file)

        prediction_file = ckpt_path + "/landrover_plus_benz_clean_plus_ford_tasb_ftmsmarcominilm_chunkbysents150_benzlandroverford_retrieved_{}_generate_43b_test_greedy_0_250_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/ford_tasb_ftmsmarcominilm_chunkbysents150_benzlandroverford_retrieved_{}_generate_43b_test_greedy_0_250_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/att_dragon_retriever_msmarcominilm_reranker_chunkbysents300_retrieved_{}_generate_43b_test_greedy_0_250_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/nq_{}_generate_43b_test_greedy_0_200_ret.txt.v2".format(n_ctx)
