...
def question_answering(Dataset, name_from_datapath_func):
...
def main():
    ...
    if args.task == 'SQUAD':
        ...
        raise NotImplementedError('Question Answering task {} is not implemented.'.format(
            args.task))

    question_answering(Dataset, name_from_datapath)
