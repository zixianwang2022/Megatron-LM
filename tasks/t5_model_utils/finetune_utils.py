...
from megatron.utils import average_losses_across_data_parallel_group as reduce_losses
...
def loss_func(loss_mask, output_tensor):
    ...
    loss = lm_loss
    averaged_losses = reduce_losses([lm_loss])
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for iteration_, batch in enumerate(train_dataloader):
            ...
            report_memory_flag = training_log(losses_dict, losses_dict_sum,
                                              ...
                                              grad_norm, None, num_zeros_in_grad)
...
def finetune(train_valid_datasets_provider, model_provider,
    ...
    model, optimizer, lr_scheduler = setup_model_and_optimizer(model_provider, ModelType.encoder_and_decoder)
    ...
    if args.iteration == 0 and args.pretrained_checkpoint is not None:
        ...
        _ = load_checkpoint(model, None, None) # pass strict=False for precision mis-match
