...
# @dataclass
# class RetroPreprocessConfig(TransformerConfig):
...
#         retro-tasks (str): Comma-separated list of tasks to run. Run entire
...
def get_retro_config():
    ...
    config = core_transformer_config_from_args(args, ty=RetroPreprocessConfig)
