...
def add_retro_args(parser):
    ...
    *Note* : Arguments prefixed with '--retro-gpt-*' or '--retro-bert-*' are
    ...
    # GPT args.
    # >>>
    group.add_argument('--retro-gpt-seed', type=int, required=True,
                       # default=1234,
                       help='Random seed used for python, numpy, '
                       'pytorch, and cuda.')
    group.add_argument('--retro-gpt-data-impl', type=str, required=True,
                       # default='infer',
    ...
    group.add_argument('--retro-gpt-data-path', nargs='*', required=True,
                       ...
                       '--*-data-path args')
    group.add_argument('--retro-gpt-split', type=str, required=True,
                       # default='969, 30, 1',
