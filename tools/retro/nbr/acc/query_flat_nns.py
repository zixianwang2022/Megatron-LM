...
def query_flat_nns():
    ...
    args.ntest = int(1e4)
    args.nnbr = 2000
    args.base_dir = "/gpfs/fs1/projects/gpu_adlr/datasets/lmcafee/retro"
    ...
    if 0:
        ...
        t = time.time()
        path = "/gpfs/fs1/projects/gpu_adlr/datasets/lmcafee/retro/v2/n2000/Flat__t65191936__neighbors.hdf5"
        f = h5py.File(path, "w")
