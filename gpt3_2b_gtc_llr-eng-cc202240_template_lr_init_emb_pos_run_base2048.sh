...
#SBATCH -p interactive -A llmservice_nlp_fm -t 00:30:00 --nodes=1 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=llmservice_nlp_fm-largelm:gpt3-eng-cc202240-1.1t-gtc-llr-muT-proxymodel-2b-lr.0002-init1.0-emb1.0-baseshape2048_bzrampup

export NCCL_IB_TIMEOUT=19
export NCCL_IB_SL=1
export CUDA_DEVICE_MAX_CONNECTIONS=1

NAME="gpt3-eng-cc202240-1.1t-gtc-llr-muT-proxymodel-2b-lr.0002-init1.0-emb1.0-baseshape2048_bzrampup"
