...
CC2240_DATA_HOME="/lustre/fsw/portfolios/adlr/projects/adlr_nlp_arch/adlr_nlp_sharing/nvllm-1.1t/data/tokens/non-english/CC-2022-40-Plus"
...
MC4_DATA_HOME="/lustre/fsw/portfolios/adlr/projects/adlr_nlp_arch/adlr_nlp_sharing/nvllm-1.1t/data/tokens/non-english/mc4-ai2"
JAMC4="${MC4_DATA_HOME}/JA_shuf_text_document"
ZHMC4="${MC4_DATA_HOME}/ZH_shuf_text_document"

NMT_DATA_HOME="/lustre/fsw/portfolios/adlr/projects/adlr_nlp_arch/adlr_nlp_sharing/nvllm-1.1t/data/tokens/non-english/nmt"
NMT="${NMT_DATA_HOME}/nmt_shuf_text_document"

#english datasets
ENG_DATA_HOME="/lustre/fsw/portfolios/adlr/projects/adlr_nlp_arch/adlr_nlp_sharing/nvllm-1.1t/data/tokens/english"
...
#code datasets
CODE_DATA_HOME="/lustre/fsw/portfolios/adlr/projects/adlr_nlp_arch/adlr_nlp_sharing/nvllm-1.1t/data/tokens/stack-subset"
