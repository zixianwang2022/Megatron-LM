...
MODEL_GEN_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/NQ/output_answer_generations_k64.txt # (e.g., /testseen_knowledge_generations.txt)
