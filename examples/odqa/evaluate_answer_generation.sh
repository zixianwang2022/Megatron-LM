...
# NQ 
MODEL_GEN_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/NQ/output_answer_generations_k1_1.3b_withnewnewGPTPrefix_l10_nogolden_withcontext_norandom_shift1.txt 
