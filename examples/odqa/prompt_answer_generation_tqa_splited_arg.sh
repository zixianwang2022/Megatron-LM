...
# OUTPUT_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/357m/output_answer_generations_k10_357m_gc_multisetdpr_queryctx_p0.9_$2_$4_withprob.txt  
...
### for the megatron API: 530b gc + 357m ans
# OUTPUT_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/api/output_answer_generations_k10_530b_gc_multisetdpr_queryctx_p0.9_$2_withoutprob.txt  
# GEN_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/GenCTX/api/api_generated_context_k10_530b_gc_multisetdpr_queryctx_p0.9_rnd1_$2.txt
# TOPK_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/analysi_result/api/topk_context_k10_530b_multisetdpr_queryctx_p0.9_$2.json

### for the megatron API: 530b gc + 1.3B ans

OUTPUT_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/1.3b/api_output_answer_generations_k10_530b_gc_multisetdpr_queryctx_p0.9_rnd1_$2.txt  
GEN_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/GenCTX/api/api_generated_context_k10_530b_gc_multisetdpr_queryctx_p0.9_rnd1_$2.txt



### for the megatron API (357m 357m gc + 357m ans
# OUTPUT_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/api/output_answer_generations_k10_357m_gc_multisetdpr_queryctx_p0.9_$2_withoutanswerprob.txt  
# GEN_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/GenCTX/api/api_generated_context_k10_357m_gc_multisetdpr_queryctx_p0.9_rnd1_new_$2.txt
# TOPK_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/analysi_result/api/topk_context_k10_357_multisetdpr_queryctx_p0.9_$2.json
