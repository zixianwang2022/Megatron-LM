...
# GEN_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/NQ/GenCTX/api_generated_context_k10_530b_gc_multisetdpr_queryctx_p0.9_rnd1.txt
...
# using the megatron API
# OUTPUT_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/output_answer_generations_k10_530b_gc_multisetdpr_queryctx_p0.9_rnd1.txt  # this means we fix all other parameters
# GEN_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/GenCTX/api_generated_context_k10_530b_gc_multisetdpr_queryctx_p0.9_rnd1.txt
# TOPK_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/analysi_result/topk_context_k10_530b_multisetdpr_queryctx_p0.9_rnd1.json
# CTX_PROMPT_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/TQA/CTX_PROMPT/context_prompt_multisetdpr_queryctx.txt
...
# OUTPUT_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/WQ/output_answer_generations_k10_530b_gc_multisetdpr_queryctx_p0.9_rnd1.txt  # this means we fix all other parameters
# GEN_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/WQ/GenCTX/api_generated_context_k10_530b_gc_multisetdpr_queryctx_p0.9_rnd1.txt
# TOPK_CTX_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/WQ/analysi_result/topk_context_k10_530b_multisetdpr_queryctx_p0.9_rnd1.json
CTX_PROMPT_PATH=/gpfs/fs1/projects/gpu_adlr/datasets/dasu/prompting/predicted/WQ/CTX_PROMPT/context_prompt_multisetdpr_queryctx.txt
