...
NAME="$CKPT-itp-32k-tian-tp16pp4"
...
# CHECKPOINT_DIR="/lustre/fsw/adlr/adlr-nlp/jcasper/checkpoints/gpt3-43b-multi-1.1t-gtc-tp8pp8/"
CHECKPOINT_DIR="/lustre/fsw/adlr/adlr-nlp/pengx/sft_43b_qa/megatron-lm/checkpoints/gpt3-43b-multi-1.1t-gtc-base-tp16pp4"
...
submit_job --gpu 8 --nodes 64 --email_mode never  --mounts "/lustre/fsw/adlr" --partition luna --image "gitlab-master.nvidia.com/adlr/megatron-lm/pytorch:22.04-py3-eval" -c "$LAUNCH ${run_cmd}" -n "${NAME}" --duration 4 --exclude luna-0253,luna-0377 #  --dependent_clones 2
