...
# model_name=qc_llama2_text_70b_cont_4k_4xbsz_70b_512_1.0e-5_70b_128_5e-6_step_250
# model_name=qc_llama2_text_70b_cont_4k_4xbsz_70b_512_1.0e-5_70b_128_5e-6_step_1000
...
bash examples/long_context_flan_llama2/generate_multijob_ckpt_step_cross_sft.sh quality.dragon_retriever_chunkbysents300 70b greedy test 0 1000 $step $num_ctxs $model_name true
bash examples/long_context_flan_llama2/generate_multijob_ckpt_step_cross_sft.sh quality.dragon_retriever_chunkbysents300 70b greedy test 1000 1000 $step $num_ctxs $model_name true
# bash examples/long_context_flan_llama2/generate_multijob_ckpt_step_cross_sft.sh quality.dragon_retriever_chunkbysents300 70b greedy test 0 1000 $step $num_ctxs $model_name
# bash examples/long_context_flan_llama2/generate_multijob_ckpt_step_cross_sft.sh quality.dragon_retriever_chunkbysents300 70b greedy test 1000 1000 $step $num_ctxs $model_name
