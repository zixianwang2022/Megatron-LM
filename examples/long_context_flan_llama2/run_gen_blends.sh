...
ash examples/long_context_flan_llama2/generate_multijob_ckpt_step_cross_sft.sh doc2dial_full_dialogue.dragon_retriever_chunkbysents300 70b greedy test 0 1000 $step $num_ctxs $model_name
