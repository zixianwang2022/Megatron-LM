...
NAME="flamingo-2b-pretrain-1e-4-ocr-randominit-aligned-train-samples-new-withdocidx-mr-wds-clip224"
LOAD_NAME="gpt3-2b-multi-1.1t-gtc"

SCRIPTS_DIR="/lustre/fsw/portfolios/llmservice/users/jbarker/workspace"
SOURCE="/lustre/fsw/portfolios/llmservice/users/jbarker/workspace/megatron-lm"

OUTPUT="/lustre/fsw/portfolios/llmservice/users/jbarker/workspace/output/${NAME}"
mkdir -p ${OUTPUT}/logs
...
DATA_TRAIN="/lustre/fsw/portfolios/llmservice/users/jbarker/workspace/data/ocr.yaml"
DATA_VALID="/lustre/fsw/portfolios/llmservice/users/jbarker/workspace/data/ocr.yaml"

VISUAL_ARCH="L_14"
VISUAL_TYPE="vit"
VISUAL_LOAD_DIR="/lustre/fsw/portfolios/llmservice/projects/llmservice_nlp_fm/checkpoints/vit/vit_L_14"
