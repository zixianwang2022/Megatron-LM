...
#SBATCH -p batch -A llmservice_nlp_fm -t 4:00:00 --nodes=16 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=8t-8x15b_upcycle_highlr_E8G8T16_clip2 --array=1-30%1
...
NAME="8t-8x15b_upcycle_highlr_E8G8T16_clip2"
...
# INIT_CHECKPOINT_DIR="/home/yihuih/llmservice/fixrouter/15b/gpt3-15b-8t-tp4-pp4_router001-te-scatter-st32xw2-E8G8"
