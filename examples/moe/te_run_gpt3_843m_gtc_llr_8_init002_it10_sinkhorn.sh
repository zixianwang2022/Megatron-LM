...
#SBATCH -p batch_block1 -A llmservice_nlp_fm -t 4:00:00 --nodes=16 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --gres=gpu:8 --dependency=singleton --job-name=llmservice_nlp_fm:te_gpt3-843m-multi-1.1t-gtc-llr_experts_8_init002_it10_sinkhorn --array=1-20%1
...
NAME="te_gpt3-843m-multi-1.1t-gtc-llr_experts_8_init002_it25_sinkhorn"
