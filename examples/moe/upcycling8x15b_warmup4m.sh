...
#SBATCH -p batch -A llmservice_nlp_fm -t 4:00:00 --nodes=64 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=llmservice_nlp_fm-yh:upcycling8x15b_warmup4m --array=1-30%1
