...
#SBATCH -p batch -A coreai_dlalgo_llm -t 4:00:00 --nodes=1 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=coreai_dlalgo_llm-yh:ct15b_lr3e-4 --array=1-30%1
