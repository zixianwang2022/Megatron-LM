...
#SBATCH -p batch,backfill,hp -A llmservice_nlp_fm -t 4:00:00 --nodes=16 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=llmservice_nlp_fm-yh:upcycling8x15b_it1_initexp_aux --array=1-10%1
...
NAME="upcycling8x15b_it1_initexp_aux"
