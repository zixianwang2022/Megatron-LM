...
##SBATCH -p batch_block1,batch_block3,batch_block4,adlr_services -A llmservice_nlp_fm -t 4:00:00 --nodes=2 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --gres=gpu:8 --dependency=singleton --job-name=llmservice_nlp_fm:te_2b_8_it10_z_aux_initexp_router001_exp001_warmup_1e-4 --array=1-30%1

#SBATCH -p batch -A llmservice_nlp_fm -t 4:00:00 --nodes=16 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=llmservice_nlp_fm-yh:te_2b_8_it10_z_aux_initexp_router001_exp001_warmup_1e-4 --array=1-20%1
...
NAME="te_2b_8_it10_z_aux_initexp_router001_exp001_warmup_1e-4"
