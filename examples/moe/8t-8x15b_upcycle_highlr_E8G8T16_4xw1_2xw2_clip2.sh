...
#SBATCH -p batch -A llmservice_nlp_fm -t 4:00:00 --nodes=16 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=8t-8x15b_upcycle_highlr_E8G8T16_4xw1_2xw2_clip2
...
NAME="8t-8x15b_upcycle_highlr_E8G8T16_4xw1_2xw2_clip2"
