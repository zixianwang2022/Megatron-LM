...
#SBATCH -p batch -A llmservice_nlp_fm -t 4:00:00 --nodes=16 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=llmservice_nlp_fm-yh:te_2b_8_lr1e-5_z_initexp_router001_exp001
...
NAME="te_2b_8_lr1e-5_z_initexp_router001_exp001"
