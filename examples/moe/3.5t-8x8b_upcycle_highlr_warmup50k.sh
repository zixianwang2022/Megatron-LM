...
#SBATCH -p batch -A coreai_dlalgo_llm -t 4:00:00 --nodes=16 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=coreai_dlalgo_llm-yh:3.5t-8x8b_upcycle_highlr_warmup50k --array=1-30%1
...
NAME="3.5t-8x8b_upcycle_highlr_warmup50k"
