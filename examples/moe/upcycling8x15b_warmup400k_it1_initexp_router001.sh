...
#SBATCH -p batch,backfill,hp -A llmservice_nlp_fm -t 4:00:00 --nodes=32 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=llmservice_nlp_fm-yh:upcycling8x15b_warmup400k_it1_initexp_router001 --array=1-10%1
...
NAME="upcycling8x15b_warmup400k_it1_initexp_router001"

DIR=`pwd`
DATETIME=`date +'date_%y-%m-%d_time_%H-%M-%S'`

INIT_CHECKPOINT_DIR="/lustre/fsw/coreai_dlalgo_llm/yihuih/checkpoints/15b/gpt3-8x15b-8t-tp8-pp8_init001"
