...
## debug
# bash examples/foundational_qa/finetune_normal_lm_fewshot.sh multiturn_qa_blendv2 43b 4 3e-7 1 gpt_1e-8_conv_quiet_cockatoo_pp1_addmultiturn

## running command
# bash examples/foundational_qa/finetune_normal_lm_fewshot.sh multiturn_qa_blendv2 43b 64 3e-7 1 gpt_1e-8_conv_quiet_cockatoo_pp1_addmultiturn
