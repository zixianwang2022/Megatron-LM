...
SAVENAME="${blend_name}_${model_card}_same_format_fewshot_fixedshot_ctx${ft_neighbours}_${model_size}_${global_bsz}_${lr}"
...
## debug
# bash examples/foundational_qa/finetune_normal_lm_fewshot_fixedshot.sh multiturn_qa_blendv2 43b 4 3e-7 1 gpt_1e-8_conv_quiet_cockatoo_pp1_addmultiturn

## running command
# bash examples/foundational_qa/finetune_normal_lm_fewshot_fixedshot.sh multiturn_qa_blendv2 43b 64 3e-7 1 gpt_1e-8_conv_quiet_cockatoo_pp1_addmultiturn
