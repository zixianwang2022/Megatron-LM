...
#SBATCH --nodes=8
#SBATCH --job-name=llmservice_nlp_fm-megatron-dev:flamingo-2b-COCO-overfit-clip-mr-wds-nostatsfix
...
NAME="flamingo-2b-1node-COCO-overfit-clip-mr-wds-nostatsfix"
