...
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh gov_report.dragon_retriever_chunkbysents300 43b greedy test 0 200 $step $num_ctxs $model_name true
...
echo bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh qmsum.dragon_retriever_chunkbysents300 43b greedy test 0 200 $step $num_ctxs $model_name
...
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh summ_screen_fd.dragon_retriever_chunkbysents300 43b greedy test 0 200 $step $num_ctxs $model_name true
...
# 
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh musique.dragon_retriever_chunkbysents300 43b greedy test 0 200 $step $num_ctxs $model_name true
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh musique.dragon_retriever_chunkbysents300 43b greedy test 0 200 $step $num_ctxs $model_name
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh hotpotqa.dragon_retriever_chunkbysents300 43b greedy test 0 200 $step $num_ctxs $model_name true
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh hotpotqa.dragon_retriever_chunkbysents300 43b greedy test 0 200 $step $num_ctxs $model_name
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh multifieldqa_en.dragon_retriever_chunkbysents300 43b greedy test 0 200 $step $num_ctxs $model_name true
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh multifieldqa_en.dragon_retriever_chunkbysents300 43b greedy test 0 200 $step $num_ctxs $model_name
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh doc2dial_full_dialogue.dragon_retriever_chunkbysents300 43b greedy test 0 1000 $step $num_ctxs $model_name true
# bash examples/long_context_flan/generate_multijob_ckpt_step_cross_sft.sh doc2dial_full_dialogue.dragon_retriever_chunkbysents300 43b greedy test 0 1000 $step $num_ctxs $model_name
