...
#SBATCH --nodes=8
#SBATCH --job-name=llmservice_nlp_fm-megatron-dev:flamingo-2b-ocr-clip336-unfrozen-fp16-torchDDP-lower-lr
...
NAME="flamingo-2b-ocr-clip336-unfrozen-fp16-torchDDP-lower-lr"
