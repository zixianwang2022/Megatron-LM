...
#SBATCH --nodes=8
#SBATCH --job-name=llmservice_nlp_fm-megatron-dev:flamingo-2b-ocr-clip336-frozen-bf16-localDDP-unfreeze-input_layernorm
...
NAME="flamingo-2b-ocr-clip336-frozen-bf16-localDDP-unfreeze-input_layernorm"
