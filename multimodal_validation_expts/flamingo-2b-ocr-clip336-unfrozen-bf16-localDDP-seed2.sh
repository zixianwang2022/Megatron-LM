...
#SBATCH --nodes=8
#SBATCH --job-name=llmservice_nlp_fm-megatron-dev:flamingo-2b-ocr-clip336-unfrozen-bf16-localDDP-seed2
...
NAME="flamingo-2b-ocr-clip336-unfrozen-bf16-localDDP-seed2"
