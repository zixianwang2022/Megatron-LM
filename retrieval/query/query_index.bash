...
BASE_DIR_PATH="/gpfs/fs1/projects/gpu_adlr/datasets/lmcafee/retrieval/index/faiss-par-add-corpus/OPQ32_256,IVF262144_HNSW32,PQ32__t3000000"
# INDEX_NAME="added"
...
for i in {00..00}; do
    ...
    CMD="\
        python -m retrieval.query.query_index \
            --index-path $INDEX_PATH \
            --feature-path /gpfs/fs1/projects/gpu_adlr/datasets/lmcafee/retrieval/data/wiki/feat/wiki.train.h5py_start_0_end_2037248_ns_2037248_sl2048_seed_1234_with_offset.tokens.00${i}.feat.hdf5 \
            --doc-path /gpfs/fs1/projects/gpu_adlr/datasets/lmcafee/retrieval/data/wiki/wiki.train.h5py_start_0_end_2037248_ns_2037248_sl2048_seed_1234_with_offset.doc_ids.pkl \
            --chunk-path /gpfs/fs1/projects/gpu_adlr/datasets/lmcafee/retrieval/data/wiki/pretraining_corpus.chunks.hdf5 \
            --out-dir $OUT_DIR \
            --out-prefix ${i} \
