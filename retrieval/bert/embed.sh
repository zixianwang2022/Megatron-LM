...
#     --output /gpfs/fs1/projects/gpu_adlr/datasets/lmcafee/retrieval/bert/0000.feat.hdf5 \
#     --bs 128 \
#     --split 16 \
#     --pointer 0
...
if [[ $HOSTNAME == *"draco-rno"* ]]; then
    ...
    python -m \
	   generation.generate_embeddings_bert_hdf5 \
	   --device 0 \
	   --input /lustre/fsw/adlr/adlr-nlp/lmcafee/data/retrieval/sampled_pretraining/sampled_pretraining_corpus.chunks.hdf5 \
	   --output /lustre/fsw/adlr/adlr-nlp/lmcafee/data/retrieval/bert/0000.feat.hdf5 \
	   --split 80 \
	   --pointer 0
