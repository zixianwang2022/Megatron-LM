...
#SBATCH -t 4:00:00
#SBATCH --exclusive
#SBATCH --job-name=adlr-nlp:retro-nextlm-gpt-43b
...
NAME="gpt3-43b-pretraining-gpt-fitting"
...
then
  ...
  LOAD_DIR="/lustre/fsw/adlr/adlr-nlp/adlr-nlp-sharing/nvllm-1.1t/checkpoints/gpt3-43b-multi-1.1t-gtc/tp8pp4vp1"
