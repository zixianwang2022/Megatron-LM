...
#SBATCH -t 4:00:00
#SBATCH --exclusive
#SBATCH --job-name=adlr-nlp:retro-nextlm-800m-tp8-distributed
...
NAME="gpt3-800m-pretraining-retro-fitting-tp8-distributed-noseqpar"
...
then
  ...
  LOAD_DIR="/lustre/fsw/adlr/adlr-nlp/adlr-nlp-sharing/nvllm-1.1t/checkpoints/gpt3-843m-multi-1.1t-gtc-llr123"
