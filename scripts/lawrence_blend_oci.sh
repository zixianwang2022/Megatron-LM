...
# CC2240_DATA_HOME="/lustre/fsw/adlr/adlr-nlp/mpatwary/data/multilingual/multi-1.1t-gtc/non-english/CC-2022-40-Plus"
...
# MC4_DATA_HOME="/lustre/fsw/adlr/adlr-nlp/mpatwary/data/multilingual/multi-1.1t-gtc/non-english/mc4-ai2"
# JAMC4="${MC4_DATA_HOME}/JA_shuf_text_document"
# ZHMC4="${MC4_DATA_HOME}/ZH_shuf_text_document"

# NMT_DATA_HOME="/lustre/fsw/adlr/adlr-nlp/mpatwary/data/multilingual/multi-1.1t-gtc/non-english/nmt"
...
# #code datasets
# CODE_DATA_HOME="/lustre/fsw/adlr/adlr-nlp/mpatwary/data/multilingual/multi-1.1t-gtc/stack-subset"
