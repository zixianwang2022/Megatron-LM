...
#SBATCH -p luna -A gpu-comparch -t 4:00:00 --nodes=8 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=gpu-comparch-psx:bf16.gpt3.357m
