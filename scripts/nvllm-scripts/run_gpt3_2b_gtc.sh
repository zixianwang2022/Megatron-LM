...
#SBATCH -p luna -A adlr -t 4:00:00 --nodes=16 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=adlr-nlp-largelm:gpt3-2b-multi-1.1t-gtc

export NCCL_IB_SL=1
export CUDA_DEVICE_MAX_CONNECTIONS=1

NAME="gpt3-2b-multi-1.1t-gtc"
...
srun -l \
     --container-image "gitlab-master.nvidia.com/adlr/megatron-lm/pytorch:22.09-py3-eval" \
