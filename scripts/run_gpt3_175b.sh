...
# NODES MUST BE 128 SO THAT fp=1 MAPS TO UPDATING EVERY 96 STEPS DUE TO GRADIENT ACCUMULATION
#SBATCH -p gtc -A gtc -t 08:00:00 --time-min 2:15:00 --nodes=128 --exclusive --mem=0 --overcommit --ntasks-per-node=8 --dependency=singleton --job-name=gtc-175b:175b.v2.hybrid.60k

NAME="175b"

DATETIME=`date +'date_%y-%m-%d_time_%H-%M-%S'`

DIR="/lustre/fsw/gpu-comparch/jkamalu/fp8-175b/v2.hybrid.60k/${NAME}"

# branch: fp8-main, commit: 15f960749588dfda5b671a1e9b2cf9dbfc0d88ca
MEGATRON_DIR="/lustre/fsw/gpu-comparch/jkamalu/fp8-175b/v2.hybrid.60k/megatron-lm.v2.hybrid.60k"
...
EXIT_DURATION=$((timeleft[0]*60 + timeleft[1] - 30))
